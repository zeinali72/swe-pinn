...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--train_max_time", type=float, default=900.0, help="Max time for training samples (default: 900.0)"
    )
    parser.add_argument(
        "--val_max_time", type=float, default=900.0, help="Max time for validation samples (default: 900.0)"
    )
    parser.add_argument(
        "--plot_time", type=float, default=900.0, help="Time for plotting dataset (default: 900.0)"
    )
    parser.add_argument(
