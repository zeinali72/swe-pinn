...
def create_datasets(
    ...
    training_max_time: float = 172800.0,
    validation_max_time: float = 172800.0, # New argument
    ...
    if not skip_validation:
        ...
        print("\nSkipping validation sampling per flag.")
    ...
    if not skip_plotting:
        ...
        print("\nSkipping plotting data extraction per flag.")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--train_max_time", type=float, default=172800.0, help="Max time for training samples (default: 72000.0)"
    )
    parser.add_argument(
        "--val_max_time", type=float, default=172800.0, help="Max time for validation samples (default: 72000.0)"
    )
    parser.add_argument(
        "--plot_time", type=float, default=172800.0, help="Time for plotting dataset (default: 72000.0)"
    )
    parser.add_argument(
        "--seed", type=int, default=42, help="Base random seed (default: 42)"
    )
    parser.add_argument(
        "--skip_val", action="store_true", help="Skip validation sampling and saving"
    )
    parser.add_argument(
        "--skip_plot", action="store_true", help="Skip plotting data extraction and saving"
    )
