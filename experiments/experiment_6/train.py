"""Experiment 6 — Synthetic complexity stage 2 (Phase 2).

Further synthetic complexity to validate robustness (split inflow + left wall).
Requires: configs/experiment_6.yaml, data/experiment_6/
...
def setup_trial(cfg_dict: dict) -> dict:
    ...
    experiment_name = get_experiment_name(cfg_dict, "experiment_6")
