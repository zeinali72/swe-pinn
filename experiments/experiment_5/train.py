...
def main(config_path: str):
    ...
    def plot_fn(final_params):
        ...
        plot_gauge_timeseries(150, 50.0, "Point 1", "P1_timeseries.png", color="blue", **gauge_kwargs)
        plot_gauge_timeseries(250.0, 50.0, "Point 2", "P2_timeseries.png", color="red", **gauge_kwargs)
