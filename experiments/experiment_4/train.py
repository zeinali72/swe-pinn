...
def make_compute_losses(bc_fn_static):
    """Return a compute_losses closure for Experiment 4 (x+y slope, split inflow)."""
...
def setup_trial(cfg_dict: dict, hpo_mode: bool = False) -> dict:
    ...
    experiment_name = get_experiment_name(cfg_dict, "experiment_4")
